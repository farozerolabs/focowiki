...
[固定版本的 OKF v0.1 specification](https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/ee67a5ca27044ebe7c38385f5b6cffc2305a9c1a/okf/SPEC.md) 定义了字段约定和 bundle 结构。Focowiki 使用相同的实用模型：Markdown pages、YAML frontmatter、links、indexes 和稳定的文件树。
