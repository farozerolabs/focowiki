    ...
    SELECT (
      ...
      AND NOT EXISTS (
        ...
        FROM (VALUES
          ...
          ('source_revision_presentations', 'metadata_parsed_at'),
          ('source_revision_presentations', 'metadata_repair_started_at'),
      ...
      AND NOT EXISTS (
        ...
        FROM unnest(ARRAY[
          ...
          'source_revision_presentations_metadata_repair_idx',
