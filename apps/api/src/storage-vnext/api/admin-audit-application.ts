...
export function createStorageVnextAdminAuditApplication(input: {
  ...
  return {
    async record(request: {
      ...
      await input.audit.append({
        ...
        actorPublicId: request.username?.trim() || null,
...
export type StorageVnextAdminAuditApplication = ReturnType<
  typeof createStorageVnextAdminAuditApplication
>;
