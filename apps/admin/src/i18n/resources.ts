      ...
      settings: {
        ...
        tips: {
          ...
          search: {
            ...
            maxInFlightTasks: "Concurrent search indexing requests. Increase this only after measuring search-service capacity; runtime backpressure pauses upstream document work when the service is saturated.",
        ...
        fields: {
          ...
          maxInFlightTasks: "Search concurrency",
      ...
      settings: {
        ...
        tips: {
          ...
          search: {
            ...
            maxInFlightTasks: "搜索索引请求并发数。仅在测量搜索服务容量后提高；服务饱和时，运行时背压会暂停上游文档处理。",
