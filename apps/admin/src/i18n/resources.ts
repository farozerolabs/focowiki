  ...
  "en-US": {
    translation: {
      ...
      tasks: {
        ...
        expandTask: "Expand task {{id}}",
        collapseTask: "Collapse task {{id}}",
        copyTaskId: "Copy task ID {{id}}",
        fileCount: "{{count}} file",
        fileCount_plural: "{{count}} files",
        progress: "{{completed}}/{{total}}",
        runningFileProgress: "{{running}} running",
        pendingFileProgress: "{{pending}} pending",
        failedFileProgress: "{{failed}} failed",
        filesTableLabel: "Files for {{id}}",
        internalPhases: "Internal phases",
        noTaskFiles: "No files recorded for this task",
        noError: "No error",
  ...
  "zh-CN": {
    translation: {
      ...
      tasks: {
        ...
        expandTask: "展开任务 {{id}}",
        collapseTask: "收起任务 {{id}}",
        copyTaskId: "复制任务 ID {{id}}",
        fileCount: "{{count}} 个文件",
        fileCount_plural: "{{count}} 个文件",
        progress: "{{completed}}/{{total}}",
        runningFileProgress: "{{running}} 个运行中",
        pendingFileProgress: "{{pending}} 个等待中",
        failedFileProgress: "{{failed}} 个失败",
        filesTableLabel: "{{id}} 的文件",
        internalPhases: "内部阶段",
        noTaskFiles: "该任务暂无文件记录",
        noError: "无错误",
        notRecorded: "未记录",
        table: {
          expand: "展开",
