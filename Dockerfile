...
RUN test -f apps/api/runtime/main.mjs && test -f apps/api/runtime/worker.mjs && test -f apps/api/runtime/migrate.mjs && test -f apps/api/runtime/search-backfill.mjs
