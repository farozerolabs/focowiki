const transitions = [
  ...
  edge("sealUploadManifest", "uploadSessionContentBatch", "session.id", "path.uploadSessionId"),
  edge("uploadSessionContentBatch", "getUploadSession", "@request.path.uploadSessionId", "path.uploadSessionId"),
  edge("getUploadSession", "listKnowledgeBaseSourceFiles", "session.knowledgeBaseId", "path.knowledgeBaseId"),
  ...
  edge("finalizeUploadSession", "getUploadSession", "session.id", "path.uploadSessionId"),
