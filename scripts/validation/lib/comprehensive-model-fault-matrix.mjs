...
export const MODEL_FAULT_CASES = Object.freeze([
  ...
  modelFault("generation", "cancellation",
    "apps/api/test/bounded-concurrent-map.test.ts",
    "stops assigning work after cancellation"),
  modelFault("generation", "pause",
    "apps/api/test/runtime-settings.test.ts",
    "creates a model without exposing the raw key and deletes it after running work ends"),
