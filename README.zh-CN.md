...
![Focowiki 架构图](./docs/public/images/focowiki-architecture.png)
...
- OKF-style generated bundle，包含 `index.md`、`log.md`、`schema.md`、`pages/*.md` 和 `_index/*.json`。
...
![Focowiki Admin UI 知识库详情页](./docs/public/images/focowiki-admin-detail.png)
